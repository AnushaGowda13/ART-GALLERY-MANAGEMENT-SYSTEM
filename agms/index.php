                        ...
                        <div class="container">
                           <div class="slider-info ">
                              ...
                              <div class="bottom-info">
                                 <p>Welcome to our Art Gallery Management System, where we simplify the display, management, and sale of stunning artworks. Explore a seamless platform for artists, visitors, and administrators to engage and experience the world of art.</p>
                              </div>
                     ...
                     <div class="slider-img two-img">
                        <div class="container">
                           <div class="slider-info ">
                              ...
                              <div class="bottom-info">
                                 <p>Discover a world of creativity with our Art Gallery Management System, designed to bring art closer to collectors and enthusiasts. Effortlessly manage exhibitions, showcase artwork, and track sales, all while fostering a dynamic space for artists and visitors to connect.</p>
                              </div>
                              <div class="outs_more-buttn">
                                 <a href="about.php">Read More</a>
                              </div>
                     ...
                     <div class="slider-img three-img">
                        <div class="container">
                           <div class="slider-info">
                              ...
                              <div class="bottom-info">
                                 <p> Showcasing the beauty of custom portraits through a seamless platform that brings together artists and art lovers. Discover unique, handcrafted portraits and experience the artistry firsthand.</p>
                              </div>
                              <div class="outs_more-buttn">
                                 <a href="about.php">Read More</a>
                              </div>
         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            ...
            <div class="row banner-below-w3l">
               ...
               <div class="col-lg-4 col-md-6 col-sm-6 mt-3 text-center banner-agile-flowers">
                  ...
                  <div class="banner-right-icon">
                     <h4 class="pt-3">Portrait Drawing</h4>
                  </div>
               </div>
